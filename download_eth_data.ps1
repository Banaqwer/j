...
Write-Host ""
Write-Host "Or load the data in Python:"
Write-Host "  from backtest_bitcoin_real import load_binance_zip_data"
Write-Host "  # (adapt the glob pattern to ETHUSDT-1d-*.zip)"
